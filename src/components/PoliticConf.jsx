export const PolitConf = () => {
  return (
    <div className="conf-popup" bis_skin_checked="1">
      <div className="popup-content" bis_skin_checked="1">
        <button className="button-back" id="backBtnPolit">
          Назад
        </button>
        <ol>
          <li>
            ...
            <ol>
              <li>
                ...
                предпринимаемые Нефейкинфо (далее — Оператор).
              </li>
              <li>
            ...
            <ol>
              <li>
                ...
                <ol>
                  ...
                  <li>
                    Га отзыв согласия на обработку персональных данных, а также,
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                Оператора nefeikinfo@yandex.ru с пометкой «Актуализация
                персональных данных».
              </li>
              <li>
                ...
                электронный адрес Оператора nefeikinfo@yandex.ru с пометкой
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                ...
                сети Интернет по адресу https://нефейкинфо.рф/.
              </li>
            </ol>
          </li>
        </ol>
